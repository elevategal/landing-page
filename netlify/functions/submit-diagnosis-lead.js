...
exports.handler = async (event) => {
  ...
  try {
    ...
    if (!BASE_ID) {
      return { statusCode: 500, headers, body: JSON.stringify({ error: 'AIRTABLE_DIAGNOSIS_BASE_ID env var not configured' }) };
    }
        ...
        records: [
          {
            fields: {
              ...
              'Tier': tier || '',
              'Runner': runner || '',
              'Q2': answers?.q2 != null ? String(answers.q2) : '',
